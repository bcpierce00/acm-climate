...
We formed the ACM SIGPLAN Climate Committee with this situation in
mind. We made presentations at SIGPLAN events, had discussions with
ACM and SIG leaders, and ultimately put together a report of ideas for
reducing the \COtwoE{} costs of conference
activities~\cite{ClimateCommitteReport}. The report considers easy 
...
Those we spoke to were almost universally supportive of reducing
\COtwoE{} emissions due to conferences, but very few were eager
to change the way we organize them. This
hesitation makes sense. Science
is a fundamentally social process, and the conference system
...
cross-fertilization. How to weigh the benefit to the environment of a
particular \COtwoE-reducing change, such as on-line PC meetings,
against the harm the change could cause to the scientific process,
such as the lost opportunity to build networks and germinate
synergistic ideas?

Scientific value and environmental harm are apples and oranges, so
they are hard to compare. They are also very hard to measure. While we
can reasonably estimate the \COtwoE{} saved by a particular change, it
is harder to guess the impact of the example it sets. This impact is
important. Emissions from air travel to conferences are the lion's
share of ACM's \COtwoE{} footprint, but air travel only contributes 
2\% of current global emissions~\cite{emissions}. This small fraction is not an excuse
for inaction. Just because any individual's or
organization's share of global emissions is miniscule does not mean it
doesn't matter. We must all contribute to the global 40\% reduction
needed by 2030 in a way that makes the most difference, and we must set an example for
others to do the same. It is especially important for scientists---who
as a community have been raising the alarm about climate change---to
not appear to be declaring themselves exempt from cutting back. But
they must do so in a smart way, or else risk disproportionately
harming the progress that science can bring. 
...
form of carbon tax, which places a monetary cost on greenhouse gas
...
challenging policy question, but it has a clear goal: It 
...
(e.g., UMD and UCLA), and companies (\mwh{Jane Street?}) have
begun to adopt internal carbon pricing policies and markets, to push
their own behavior closer to a sustainable equilibrium. We feel that ACM
...
worked the ACM SGB to develop a \COtwoE{} calculator that takes such
...
conference, to assess the tax. \mwh{other \COtwoE{} costs?}
%
...
over time as organizers start to adapt to it. On the other hand, the true
