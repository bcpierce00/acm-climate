...
onto a common scale (money), economic markets can be viewed as massively
...
society---i.e., it should be imposed by governments.  Indeed, many
countries\bcp{e.g.?} and states (e.g., California) have already adopted
carbon pricing policies; more will follow.
%
Bottom line: We are entering an era in which carbon will be expensive.

Anticipating this era, what should we rationally do now to ensure that ACM,
and computer-science research more broadly, continue to thrive in a world
