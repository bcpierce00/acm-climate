...
How should ACM respond to these facts?  We have two concrete proposals.
...
These are things that we can and should be doing now.  Indeed, many parts
of ACM are already doing them.  (In SIGPLAN, we have... and the experience
has been...)
...
But there is another, deep reason why going beyond simple measures is hard:
while conferences damage the climate, they also create significant value!
...
This presents a puzzle: How can we weigh the environmental harm caused by
conference travel against the social benefits of the scientific progress
that comes from conferences?  The question is difficult because the harm and
the compensating benefits cannot be directly compared---they are apples and
oranges.
...
\SECTION{Put a Price on Carbon.}
  ...
  \item The money raised in this way can be used in many ways: buying carbon
  offsets, supporting ``green computing research'', virtualizing conferences
