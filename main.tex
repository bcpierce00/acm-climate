...
Philadelphia to Paris emits the equivalent of about 1.7 tons of carbon dioxide
(\COtwoE) per passenger.\mwh{Cite the carboncalculator.org site I used
  to calculate this?} Compare this against the fact that the average US
...
another obvious step. \mwh{data about surprising connection to
  conference's overall footprint?}  Indeed, this switch is already happening: we found in
...
virtual \mwh{reality?} conferences~\cite{OS}.  ACM members can contribute to the
...
short-term solutions will require balancing competing concerns, demanding
discussion, compromise, careful analysis of data, and creative
experimentation.  
%
\bcp{Added remainder of paragraph.  I don't think the two sentences work
together very well, but I can't decide which to keep!}
It will also require questioning some fundamental assumptions about how
...
airports.
%
And to thrive in the long term, we need to begin imagining what a
zero-carbon professional society will look like.
