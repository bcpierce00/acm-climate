...
One potential sticking point is that some strategies for reducing carbon
footprints---such as encouraging some (or all\cite{NCN}!)  participants to
attend remotely---will also reduce conference revenues; in the limit, this
could significantly impact the income stream of ACM itself, which could make
emissions reduction politically unpalatable unless ACM's conference-focused
business model is also adjusted.  Planning for this eventuality should start
now.
