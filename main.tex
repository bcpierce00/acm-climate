...
%
For ACM, this means that the carbon cost of conferences should be
...
In the longer term, this cost should be imposed from outside, by governments.
...
%
In the short term, we can choose to do it voluntarily using carbon
offsets.  
\begin{itemize}
\item (What they are.)
