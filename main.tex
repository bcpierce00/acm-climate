...
intensively with members, conference organizers, ACM staff, and leaders of
other SIGs, we are putting forward two concrete proposals. First, all ACM
conferences should publicly {\em account} for the {\COtwoE} emitted as a
result of putting them on. Second, ACM \iflater\bcp{Are we really
...
conferences\iflater~\cite{carboncalculator}\bcp{Trim citation?  Is it even
  ...
  dead!}\fi. Users can upload conference registration data, and the
