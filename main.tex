...
passenger~\cite{carboncalculator}, which is a significant fraction of the
...
transportation, travel to in-person PC meetings, and estimated emissions
from hotel and food.
...
conferences\iflater~\cite{ClimateCommittee}.  Users can upload conference
registration data, and the calculator will estimate the {\COtwoE} cost of
air travel for those sufficiently far away. This calculator could be
...
what we have not measured.  And ACM is well positioned to develop tools that
other academic societies can adopt.
...
Similarly, SIGPLAN has been considering how to reduce emissions over the
past few years, informed by an accounting of its own {\COtwoE}
emissions. This discussion has led the organizers of two flagship
...
\caption{Top: Carbon footprint per participant for travel to recent SIGPLAN
  ...
  green for Asia.
% \iflater\bcp{Richard: I find this a
...
However, while public accounting of {\COtwoE} will encourage easy
...
%
These disparate perspectives suggest that reducing conference emissions may
...
analogy,
some municipalities including New York City and Philadelphia have imposed a
...
short-term expedient that buys a little time to develop strategies for more
difficult cuts.
%
...
models, once-a-year megaconferences, and entirely virtual
...
Another key issue in implementation of this second proposal will be how to
...
We in ACM should do our part by mandating public accounting of conference
carbon footprints and by putting a concrete price on the carbon that we use.
