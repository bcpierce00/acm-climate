...
``carbon'') per
passenger~\cite{carboncalculator}. This is a significant fraction of the
...
models, yearly megaconferences, and entirely virtual
...
their own contributions, raise awareness and foster discussion among their
