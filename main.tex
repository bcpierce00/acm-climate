...
On the other hand, conferences obviously also create significant value.
...
This presents a puzzle: How do we weigh the environmental harm caused by
...
Discussions about the future of conferences also require data.  
%
...
%   below.} 
\bcp{Bad transition here.  The rest of this section needs reorg.}
For conferences, there are many options that one might
contemplate~\cite{ClimateCommitteReport}, from easy-but-incremental changes
like making program committee meetings virtual instead of physical and
enabling virtual participation via live-streaming, all the way to complete
re-imagining of conferences and their role in science (holding conferences
completely in virtual spaces, replacing conferences with journals, etc.),
with some intriguing hybrid forms in the middle (regional conferences,
mega-conferences, conferences held simultaneously at two locations on
