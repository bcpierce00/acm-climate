...
imagine many good uses, including carbon offsetting, 
defraying the costs of virtualizing conferences (livestreaming, etc.),
and supporting ``green''
computing research. For an example of the last: what if ACM funded a major cross-cutting
...
virtual setting? We would hope that the cost of carbon pricing and the funding of
initiatives such as this will stimulate creative rethinking of the conference model
