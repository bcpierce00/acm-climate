...
%
\begin{itemize}
\item Lots of organizations (universities, companies) are already doing
this; some ACM conferences are starting to experiment with voluntary carbon
offset fees at registration time.
\end{itemize}
