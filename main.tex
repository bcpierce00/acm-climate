...
passenger\iflater\bcp{Citation?  Yes, to the same carbon calculator that we
  recommend elsewhere!}\fi, a significant fraction of the
...
How should ACM respond to these facts?  In 2016, ACM's Special
...
rolling a carbon offset into the registration fee for every participant.
