...
conference.\footnote{We acknowledge that carbon offsets are a
  controversial tool\bcp{Cite the thing the reviewer pointed us to, as well
    as the recent controversial UN report.}.  Besides issues with
  ...
  are a short-term measure, to be considered in parallel with, not instead
  of, more difficult cutting.}
...
\caption{Top: carbon footprint per participant for travel to recent SIGPLAN
  conferences\iflater\bcp{Get better file from the other paper, or get
    better version of this one from Crista.}\fi.  Middle: Origin of
  participants for each conference. \bcp{Explain in more detail, once we
    have Crista's new figures.} Bottom: Distances traveled by participants, one way, in Km; middle dashed line is the median travel distance.}
\label{fig:confs}
\end{figure}
...
corporate sponsorship, or by other, more creative, means. \mwh{Problem: We showed
