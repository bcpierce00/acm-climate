...
\bcp{Polish and expand with reworked old text and new points.}
Finally, we can start imposing a cost on ourselves by using carbon
offsets.  (People counter-argue that this "lets people off the hook" and
...
\item {\bf Analyze} your organization's carbon-emitting activities to inform
a discussion of how reduce its footprint and prepare for the era of
expensive carbon.
\end{itemize}
