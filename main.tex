...
\bcp{Richard Kim sent a bunch of great comments!  In particular...
  ...
  one's neck out, but there could be something about how computer science \&
...
\bcp{Consider all of Mike's cuts.}

\bcp{Take out details of registration data.}
...
General Motors, Delta Airlines, Lyft, and Expedia, universities,
and academic societies, now buy carbon offsets in order to reduce their
...
conferences\iflater~\cite{carboncalculator}\bcp{Trim citation?  Is it even
  ...
  use it, even if just, "To learn more about the calculator, e-mail
  \_\_\_\_\_\_\_\_\_."''}\fi. Users can upload conference registration data, and the
...
\bcp{Close with a discussion-starter based on the second reviewer's last
  review.} 
...
coming at us.  We in ACM must step up and play our part.
